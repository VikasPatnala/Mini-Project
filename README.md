...
The [algorithm](Code/main.cpp) will find convex hull of given 2d points the [image](Images/100-points.png) is convex hull of 100 [random points](Code/input.csv)
